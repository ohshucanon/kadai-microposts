    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <ul class="nav nav-tabs nav-justified mb-3">
                ...
                <li class="nav-item"><a href="{{ route('users.favorites', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/favorite') ? 'active' : '' }}">Favorites <span class="badge badge-secondary">{{ $count_favorites }}</srspan></a></li>
            </ul>
